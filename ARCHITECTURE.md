...
What remains uncovered is most of the rest of the file: the rate-limit backoff, the scout and resolver handoff, the no-commit and dirty-tree recovery branches. A sequencing regression in those is still the highest-blast-radius bug available here.
